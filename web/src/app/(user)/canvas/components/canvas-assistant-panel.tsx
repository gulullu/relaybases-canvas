    ...
    return (
        <Select value={current} onValueChange={onChange}>
            <SelectTrigger
                ...
                title={current ? modelOptionName(current) : "选择文本模型"}
            ...
            >
                {options.length ? (
                    options.map((model) => (
                        <SelectItem key={model} value={model} textValue={modelOptionName(model)}>
