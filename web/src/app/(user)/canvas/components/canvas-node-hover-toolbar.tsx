...
function ToolbarAction({ title, label, icon, onClick, showLabel, active = false, danger = false }: ToolbarTool & { showLabel: boolean }) {
    ...
    return (
        <Tooltip title={title} placement="top" mouseEnterDelay={0.2} color="#ffffff" styles={{ root: { color: "#242529", fontSize: 13, fontWeight: 500 }, container: { boxShadow: "0 8px 24px rgba(15,23,42,.16)" } }}>
